...
void render(GLFWwindow* window) {
    ...
    program.add_shader("shaders/hello_uniforms.vert", GL_VERTEX_SHADER);
    program.add_shader("shaders/hello_uniforms.frag", GL_FRAGMENT_SHADER);
    program.link();
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        program.set_uniform("ourColour", {0.0f, green_value, 0.0f, 1.0f});
