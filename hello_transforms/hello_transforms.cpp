...
void render(GLFWwindow* window) {
    ...
    program.add_shader("shaders/hello_transforms.vert", GL_VERTEX_SHADER);
    program.add_shader("shaders/hello_transforms.frag", GL_FRAGMENT_SHADER);
    program.link();
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        float scale         = std::sin(time) * 0.5f + 1.0f;
        glm::mat4 transform = glm::mat4(1.0f);
        transform           = glm::rotate(transform, glm::radians(16.0f * time), glm::vec3(0.0f, 0.0f, 1.0f));
