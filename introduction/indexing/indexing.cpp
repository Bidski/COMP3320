...
int main() {
    ...
    // --------------------
    GLFWwindow* window =
        glfwCreateWindow(SCREEN_WIDTH, SCREEN_HEIGHT, "COMP3320 OpenGL Introduction: Element Buffers", NULL, NULL);
    if (window == NULL) {
...
void render(GLFWwindow* window) {
    ...
    program.add_shader("shaders/indexing/indexing.vert", GL_VERTEX_SHADER);
    program.add_shader("shaders/indexing/indexing.frag", GL_FRAGMENT_SHADER);
    program.link();
