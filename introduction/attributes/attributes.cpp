...
int main() {
    ...
    // --------------------
    GLFWwindow* window =
        glfwCreateWindow(SCREEN_WIDTH, SCREEN_HEIGHT, "COMP3320 OpenGL Introduction: Vertex Attributes", NULL, NULL);
    if (window == NULL) {
...
void render(GLFWwindow* window) {
    ...
    program.add_shader("shaders/attributes/attributes.vert", GL_VERTEX_SHADER);
    program.add_shader("shaders/attributes/attributes.frag", GL_FRAGMENT_SHADER);
    program.link();
