...
int main() {
    ...
    // --------------------
    GLFWwindow* window =
        glfwCreateWindow(SCREEN_WIDTH, SCREEN_HEIGHT, "COMP3320 OpenGL Introduction: Multiple Objects", NULL, NULL);
    if (window == NULL) {
...
void render(GLFWwindow* window) {
    ...
    program.add_shader("shaders/multi_cube/multi_cube.vert", GL_VERTEX_SHADER);
    program.add_shader("shaders/multi_cube/multi_cube.frag", GL_FRAGMENT_SHADER);
    program.link();
    ...
    // load textures
    // -------------
    utility::gl::texture wall_texture("textures/multi_cube/wall.jpg", GL_TEXTURE_2D);
    ...
    utility::gl::texture face_texture("textures/multi_cube/awesomeface.png", GL_TEXTURE_2D);
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        glm::mat4 Hvw = glm::translate(glm::mat4(1.0f), glm::vec3(0.0f, 0.0f, -10.0f));
        Hvw           = glm::rotate(Hvw, glm::radians(time * 25.0f), glm::vec3(1.0f, 0.0f, 0.0f));
        ...
        for (size_t i = 0; i < cube_positions.size(); ++i) {
            ...
            Hwm           = glm::rotate(Hwm, glm::radians(time * 50.0f + i * 20.0f), glm::vec3(1.0f, 0.3f, 0.5f));
